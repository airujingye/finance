...
<div class="container-fluid gmp GMAdmin">
	...
	<form style="width:100%;height:100%;" id="listForm" method="post" class="form-horizontal" action="Gmsecurity!update.action" role="form">
							  	...
							  	<div role="tabpanel" class="col-md-12 tab-pane active" id="tabgmbbaseuser">
							  		...
							  		<input type="hidden" id="isAddAction" value="${isAddAction}" />
															<div class="form-group col-lg-4 col-md-6 col-sm-6 col-xs-6">
																<label class="col-sm-4 control-label gmbbp_inputtext">
																	用户名:
																</label>
																<div class="col-sm-8">
																	<input type="text" class="form-control gmbbp_input " maxlength="64"
																		name="gmbbaseuser.username" value="${gmloginuser.username}"
																		placeholder="用户名"/>
																</div>
															</div>
															<div class="form-group col-lg-4 col-md-6 col-sm-6 col-xs-6">
																...
																<div class="col-sm-8">
																	<input type="password" class="form-control gmbbp_input gmb_password " maxlength="128"
																		name="gmbbaseuser.password" value="${gmloginuser.password}"
																		placeholder="密码"/>
																</div>
															</div>
															<div class="form-group col-lg-4 col-md-6 col-sm-6 col-xs-6">
																...
																<div class="col-sm-8">
																	<input type="text" class="form-control gmbbp_input " maxlength="32"
																		name="gmbbaseuser.gmusertype" value="${gmloginuser.gmusertype}"
																		placeholder="用户类型"/>
																</div>
															</div>
							  	</div>
