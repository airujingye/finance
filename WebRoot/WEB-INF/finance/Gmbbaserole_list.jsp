...
<div class="container-fluid gmp GMAdmin ">
	...
	<form id="listForm" class="form-horizontal" method="post" action="Gmbbaserole!gmbList.action">
	  			...
	  			<div class="col-md-10 gmbbp_contentbox gmbbp_height gmbbp_size_right">
		  			<div class="col-md-12 gmbbp_content_right">
						...
						<div class="col-md-12 gmbbp_con_righttitle">
							<div class="col-md-7">
								<div class="gmbbp_conright_logo">&nbsp;&nbsp;基础角色管理</div>
								<div class="gmbbp_conright_msg">
										<button type="button" class="btn btn-default" style="border: 0px solid;" id="addButton" url="Gmbbaserole!gmbAdd.action?handle=forwardAddPage">
											<span class="glyphicon glyphicon-plus-sign gmss_span1" aria-hidden="true"></span> 添加
										</button>
										<button type="button" class="btn btn-default" style="border: 0px solid;" id="deleteButton" data-toggle="modal" data-target="#delModal" url="Gmbbaserole!gmbDelete.action" disabled>
									...
									<div class="dropdown gmbbp_pagemsg">
									    ...
									    <ul class="dropdown-menu gmbbp_select" role="menu" aria-labelledby="dropdownMenu1">						
											<li class="mpageactive"><a href="Gmbbaserole!gmbAdd.action?handle=forwardbatchAddPage">批量添加</a></li>
											<li url="Gmbbaserole!gmbAdd.action?handle=forwardAjaxAdd&importState=true&fields=id,name" class="gmbtnupload" id="gmb_batch_import_path"><a href="#">批量导入</a></li>
							...
							<div class="col-md-5 gmbbp_size_right">
								<div class="gmbbp_conright_search gmbbp_size_right">
									<div class="visible-lg-inline-block visible-sm-inline-block visible-md-inline-block visible-xs-inline-block gmbbp_size_right">
										<input type="text" class="form-control input-sm gmbbp_conseach" name="fullSearch" value="" placeholder="角色名称  " id="fullSearch"/>&nbsp;&nbsp;
						...
						<div class="col-md-12 panel-body panel-table" style="padding:0px;" url="<%=gmBase %>/finance/Gmbbaserole!gmbList.action?handle=forwardListPage">
							<jsp:include page="Gmbbaserole_table.jsp"></jsp:include>
						</div>
					</div>
				</div>	
			</div>
				...
				<div class="modal-body">
					<div class="input-group">
						...
						<div class="form-group col-sm-6 gmbbp_search_formgroup">
							<label  class="col-sm-4 control-label gmbbp_inputtext">角色名称：</label>
							<div class="col-sm-8">
							    ...
							    <input type="text" class="form-control gmp_input" name="searchFilter.searchFilters[0].stringValue"
									value="${gmbbaserole.name}" placeholder="角色名称" />
							</div>
						</div>
					</div>
					<!-- 高级查询表单结束 -->
	...
	<div tabindex="-1" class="modal fade" id="batchExport" role="dialog" aria-hidden="true" aria-labelledby="myModalLabel">
		<div class="modal-dialog">
			<div class="modal-content gmbbp_search_box">
				...
				<div class="modal-footer gmbbp_search_foot">
					<a class="gmbbp_list_displaynone" href="Gmbbaserole!gmbList.action?handle=forwardAjaxList&exportState=true&fields=" style="display:none;"></a>
