...
<div class="container-fluid gmp GMAdmin">
	...
	<form style="width:100%;height:100%;display:inline-block;" id="listForm" method="post" class="form-horizontal column ui-sortable gmbbp_cont_treeborderNo" action="Gmbbasemenu!${isAddAction?'gmbAdd':'gmbUpdate'}.action" role="form">
							...
							<div class="col-md-12">
								...
								<div class="gmbbp_cont_treecon" style="padding-left:20px;display:none;">
									...
									<div class="zTreeDemoBackground left bg-ztree">
										<ul id="treegmbbasemenu_input" class="ztree GMZtree" gmOnClick="zTreeOnClick" gmTreeIsEnable="false" gmTreeShowName="name" gmTreeUrl="<%=gmBase%>/finance/Gmbbasemenu!gmbList.action?handle=forwardListParentTree"></ul>
									</div>
								</div>
							</div>						
						</div>
			...
			<div class="col-md-10 gmbbp_contentbox gmbbp_height gmbbp_size_right">
				<div class="col-md-12 gmbbp_content_right">
					<div class="col-md-12 gmbbp_con_righttitle">
						<!--内容右侧title部分开始-->
						<div class="gmbbp_conright_logo">&nbsp;&nbsp;${isAddAction?'创建':'编辑'}菜单表</div>
					</div>
					<!--右侧编辑部分-->
					<div class="col-md-12 gmbbp_int_formcreat gmb_pageinfo">
						<div class="col-md-12 gmbbp_int_formlisttitle">
							<ul class="nav nav-tabs gmbbp_tab_panel column ui-sortable" role="tablist">
								<li role="presentation" class="lyrow ui-draggable active" data-setting = "1"><a href="#tabgmbbasemenu" aria-controls="home" role="tab" data-toggle="tab">菜单表基本信息</a></li>
							</ul>
						</div>
								...
								<div class="col-md-12 column ui-sortable gmbbp_cont_treeborderNo">
											...
											<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
												<input type="text" class="form-control gmbbp_input " maxlength="64"
													name="gmbbasemenu.name" value="${gmbbasemenu.name}"
													placeholder="名称"/>
											</div>
										</div>
									<div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12 lyrow ui-draggable" data-setting = "1">
										...
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
											<input type="text" class="form-control gmbbp_input ajaxuniqueValid " defaultvalue="${gmbbasemenu.keyword}" src="Gmbbasemenu!uniqueValid.action"
												name="gmbbasemenu.keyword" value="${gmbbasemenu.keyword}" placeholder="关键字" required
									...
									<div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12 lyrow ui-draggable " data-setting = "1">
										...
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
											<select class="form-control gmbbp_input " name="gmbbasemenu.isParent" placeholder="是否父节点">
												<option value="">请选择</option>
												<option value="true" ${(gmbbasemenu.isParent||isAddAction)?'selected="selected"':''}>是</option>
												<option value="false" ${(!gmbbasemenu.isParent&&!isAddAction||(!isCatalog&&isAddAction))?'selected="selected"':''}>否</option>
											</select>
										</div>
									</div>
									<div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12 lyrow ui-draggable" data-setting = "1">
										...
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
											<div class="input-group from-tree" gmZtreeTid="nameparentNode" title="点击选择节点" gmKeyName="name"
												...
												<input type="hidden" name="gmbbasemenu.parentid" value="${isAddAction ? addGmbbasemenu.id==null?"0":addGmbbasemenu.id : gmbbasemenu.parentid }" readonly/>
										...
										<div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12 lyrow ui-draggable" data-setting = "1">
											...
											<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
												<input type="text" class="form-control gmbbp_input " maxlength="512"
													name="gmbbasemenu.url" value="${gmbbasemenu.url}"
													placeholder="菜单地址"/>
											</div>
										</div>
								</div>
