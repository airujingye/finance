...
<div class="container-fluid gmp GMAdmin ">
	...
	<form id="listForm" class="form-horizontal" method="post" action="Gmbbaseuser!gmbList.action">
	  			...
	  			<div class="col-md-10 gmbbp_contentbox gmbbp_height gmbbp_size_right">
		  			<div class="col-md-12 gmbbp_content_right">
						...
						<div class="col-md-12 gmbbp_con_righttitle">
							<div class="col-md-7">
								<div class="gmbbp_conright_logo">&nbsp;&nbsp;基础用户管理</div>
								<div class="gmbbp_conright_msg">
										<button type="button" class="btn btn-default" style="border: 0px solid;" id="addButton" url="Gmbbaseuser!gmbAdd.action?handle=forwardAddPage">
											<span class="glyphicon glyphicon-plus-sign gmss_span1" aria-hidden="true"></span> 添加
										</button>
										<button type="button" class="btn btn-default" style="border: 0px solid;" id="deleteButton" data-toggle="modal" data-target="#delModal" url="Gmbbaseuser!gmbDelete.action" disabled>
									...
									<div class="dropdown gmbbp_pagemsg">
									    ...
									    <ul class="dropdown-menu gmbbp_select" role="menu" aria-labelledby="dropdownMenu1">						
											<li class="mpageactive"><a href="Gmbbaseuser!gmbAdd.action?handle=forwardbatchAddPage">批量添加</a></li>
											<li url="Gmbbaseuser!gmbAdd.action?handle=forwardAjaxAdd&importState=true&fields=id,username,password,gmusertype,zhname" class="gmbtnupload" id="gmb_batch_import_path"><a href="#">批量导入</a></li>
							...
							<div class="col-md-5 gmbbp_size_right">
								<div class="gmbbp_conright_search gmbbp_size_right">
									<div class="visible-lg-inline-block visible-sm-inline-block visible-md-inline-block visible-xs-inline-block gmbbp_size_right">
										<input type="text" class="form-control input-sm gmbbp_conseach" name="fullSearch" value="" placeholder="用户名 密码 用户类型 姓名  " id="fullSearch"/>&nbsp;&nbsp;
												<input type="hidden" name="searchColumns" value="username">
												<input type="hidden" name="searchColumns" value="password">
												<input type="hidden" name="searchColumns" value="gmusertype">
												<input type="hidden" name="searchColumns" value="zhname">
										<div class="btn-group">
						...
						<div class="col-md-12 panel-body panel-table" style="padding:0px;" url="<%=gmBase %>/finance/Gmbbaseuser!gmbList.action?handle=forwardListPage">
							<jsp:include page="Gmbbaseuser_table.jsp"></jsp:include>
						</div>
					</div>
				</div>	
			</div>
				...
				<div class="modal-body">
					<div class="input-group">
						...
						<div class="form-group col-sm-6 gmbbp_search_formgroup">
							<label  class="col-sm-4 control-label gmbbp_inputtext">用户名：</label>
							<div class="col-sm-8">
								<input type="hidden" name="searchFilter.searchFilters[0].columnName" value="username" />
							    ...
							    <input type="text" class="form-control gmp_input" name="searchFilter.searchFilters[0].stringValue"
									value="${gmbbaseuser.username}" placeholder="用户名" />
							</div>
						</div>
						<div class="form-group col-sm-6 gmbbp_search_formgroup">
							<label  class="col-sm-4 control-label gmbbp_inputtext">密码：</label>
							<div class="col-sm-8">
								<input type="hidden" name="searchFilter.searchFilters[1].columnName" value="password" />
							    ...
							    <input type="text" class="form-control gmp_input" name="searchFilter.searchFilters[1].stringValue"
									value="${gmbbaseuser.password}" placeholder="密码" />
							</div>
						</div>
						<div class="form-group col-sm-6 gmbbp_search_formgroup">
							<label  class="col-sm-4 control-label gmbbp_inputtext">用户类型：</label>
							<div class="col-sm-8">
								<input type="hidden" name="searchFilter.searchFilters[2].columnName" value="gmusertype" />
							    ...
							    <input type="text" class="form-control gmp_input" name="searchFilter.searchFilters[2].stringValue"
									value="${gmbbaseuser.gmusertype}" placeholder="用户类型" />
							</div>
						</div>
						<div class="form-group col-sm-6 gmbbp_search_formgroup">
							<label  class="col-sm-4 control-label gmbbp_inputtext">姓名：</label>
							<div class="col-sm-8">
								<input type="hidden" name="searchFilter.searchFilters[3].columnName" value="zhname" />
							    ...
							    <input type="text" class="form-control gmp_input" name="searchFilter.searchFilters[3].stringValue"
									value="${gmbbaseuser.zhname}" placeholder="姓名" />
							</div>
						</div>
					</div>
					<!-- 高级查询表单结束 -->
	...
	<div tabindex="-1" class="modal fade" id="batchExport" role="dialog" aria-hidden="true" aria-labelledby="myModalLabel">
		<div class="modal-dialog">
			<div class="modal-content gmbbp_search_box">
						...
						<table class="table">
							<tbody>
								<tr>
									...
									<tr>
										<td><input type="checkbox" name="gmbbp_modal_ids" value="username" class="gmbbp_modal_ids"></td>
										<td>用户名</td>
									</tr>
									<tr>
										<td><input type="checkbox" name="gmbbp_modal_ids" value="password" class="gmbbp_modal_ids"></td>
										<td>密码</td>
									</tr>
									<tr>
										<td><input type="checkbox" name="gmbbp_modal_ids" value="gmusertype" class="gmbbp_modal_ids"></td>
										<td>用户类型</td>
									</tr>
									<tr>
										<td><input type="checkbox" name="gmbbp_modal_ids" value="zhname" class="gmbbp_modal_ids"></td>
										<td>姓名</td>
									</tr>
							</tbody>
						</table>
				...
				<div class="modal-footer gmbbp_search_foot">
					<a class="gmbbp_list_displaynone" href="Gmbbaseuser!gmbList.action?handle=forwardAjaxList&exportState=true&fields=" style="display:none;"></a>
