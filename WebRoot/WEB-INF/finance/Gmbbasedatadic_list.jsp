...
<div class="container-fluid gmp GMAdmin ">
	...
	<form id="listForm" class="form-horizontal" method="post" action="Gmbbasedatadic!gmbList.action?id=${id}">
							...
							<div class="col-md-12">
								...
								<div class="gmbbp_cont_treecon" style="padding-left:20px;display:none;">
									...
									<div class="zTreeDemoBackground left bg-ztree">
										<ul id="treegmbbasedatadic_list" class="ztree GMZtree" gmOnClick="zTreeOnClick" gmTreeIsEnable="false" gmTreeShowName="name" gmTreeUrl="<%=gmBase%>/finance/Gmbbasedatadic!gmbList.action?handle=forwardListParentTree"></ul>
									</div>
								</div>
							</div>						
						</div>
	  			...
	  			<div class="col-md-10 gmbbp_contentbox gmbbp_height gmbbp_size_right">
		  			<div class="col-md-12 gmbbp_content_right">
						...
						<div class="col-md-12 gmbbp_con_righttitle">
							<div class="col-md-7">
								<div class="gmbbp_conright_logo">&nbsp;&nbsp;数据字典管理</div>
								<div class="gmbbp_conright_msg">
										<button type="button" class="btn btn-default" style="border: 0px solid;" id="addButton" url="Gmbbasedatadic!gmbAdd.action?handle=forwardAddPage">
											<span class="glyphicon glyphicon-plus-sign gmss_span1" aria-hidden="true"></span> 添加
										</button>
										<button type="button" class="btn btn-default" style="border: 0px solid;" id="deleteButton" data-toggle="modal" data-target="#delModal" url="Gmbbasedatadic!gmbDelete.action" disabled>
									...
									<div class="dropdown gmbbp_pagemsg">
									    ...
									    <ul class="dropdown-menu gmbbp_select" role="menu" aria-labelledby="dropdownMenu1">						
											<li class="mpageactive"><a href="Gmbbasedatadic!gmbAdd.action?handle=forwardbatchAddPage">批量添加</a></li>
											<li url="Gmbbasedatadic!gmbAdd.action?handle=forwardAjaxAdd&importState=true&fields=id,name,code,parentid,isParent,description,isInternal,gmkeycode,gmorder" class="gmbtnupload" id="gmb_batch_import_path"><a href="#">批量导入</a></li>
							...
							<div class="col-md-5 gmbbp_size_right">
								<div class="gmbbp_conright_search gmbbp_size_right">
									<div class="visible-lg-inline-block visible-sm-inline-block visible-md-inline-block visible-xs-inline-block gmbbp_size_right">
										<input type="text" class="form-control input-sm gmbbp_conseach" name="fullSearch" value="" placeholder="名称 代码 父节点 描述 关键字  " id="fullSearch"/>&nbsp;&nbsp;
												<input type="hidden" name="searchColumns" value="name">
												<input type="hidden" name="searchColumns" value="code">
												<input type="hidden" name="searchColumns" value="parentid">
												<input type="hidden" name="searchColumns" value="description">
												<input type="hidden" name="searchColumns" value="gm_keycode">
										<div class="btn-group">
						...
						<div class="col-md-2 gmbbp_right_menubox">
							<div class="col-md-12 gmbbp_right_menu">
								<div class="zTreeDemoBackground left bg-ztree">
									<ul id="treegmbbasedatadic_list1" class="ztree GMZtree" gmOnClick="zTreeOnClick" gmTreeIsEnable="false" gmTreeShowName="name" gmTreeUrl="<%=gmBase%>/finance/Gmbbasedatadic!gmbList.action?handle=forwardListParentTree"></ul>
								</div>
							</div>
						</div>	
						<div class="col-md-10 panel-body panel-table" style="padding:0px;" url="<%=gmBase %>/finance/Gmbbasedatadic!gmbList.action?handle=forwardListPage">
							<jsp:include page="Gmbbasedatadic_table.jsp"></jsp:include>
						</div>
					</div>
				</div>	
			</div>
			...
			<div class="modal-content gmbbp_search_box">
				...
				<div class="modal-body">
					<div class="input-group">
						...
						<div class="form-group col-sm-6 gmbbp_search_formgroup">
							...
							<div class="col-sm-8">
							    ...
							    <input type="text" class="form-control gmp_input" name="searchFilter.searchFilters[0].stringValue"
									value="${gmbbasedatadic.name}" placeholder="名称" />
							</div>
						</div>
						<div class="form-group col-sm-6 gmbbp_search_formgroup">
							<label  class="col-sm-4 control-label gmbbp_inputtext">代码：</label>
							<div class="col-sm-8">
								<input type="hidden" name="searchFilter.searchFilters[1].columnName" value="code" />
							    ...
							    <input type="text" class="form-control gmp_input" name="searchFilter.searchFilters[1].stringValue"
									value="${gmbbasedatadic.code}" placeholder="代码" />
							</div>
						</div>
						<div class="form-group col-sm-6 gmbbp_search_formgroup">
							<label  class="col-sm-4 control-label gmbbp_inputtext">父节点：</label>
							<div class="col-sm-8">
								<input type="hidden" name="searchFilter.searchFilters[2].columnName" value="parentid" />
							    ...
							    <input type="text" class="form-control gmp_input" name="searchFilter.searchFilters[2].stringValue"
									value="${gmbbasedatadic.parentid}" placeholder="父节点" />
							</div>
						</div>
						<div class="form-group col-sm-6 gmbbp_search_formgroup">
							<label  class="col-sm-4 control-label gmbbp_inputtext">是否是父节点：</label>
							<div class="col-sm-8">
								...
								<select class="form-control gmbbp_search_input" name="searchFilter.searchFilters[3].stringValue" placeholder="是否是父节点">
						...
						<div class="form-group col-sm-6 gmbbp_search_formgroup">
							<label  class="col-sm-4 control-label gmbbp_inputtext">描述：</label>
							<div class="col-sm-8">
								<input type="hidden" name="searchFilter.searchFilters[4].columnName" value="description" />
							    ...
							    <input type="text" class="form-control gmp_input" name="searchFilter.searchFilters[4].stringValue"
									value="${gmbbasedatadic.description}" placeholder="描述" />
							</div>
						</div>
						<div class="form-group col-sm-6 gmbbp_search_formgroup">
							<label  class="col-sm-4 control-label gmbbp_inputtext">内置数据：</label>
							<div class="col-sm-8">
								<input type="hidden" name="searchFilter.searchFilters[5].columnName" value="isInternal" />
								...
								<select class="form-control gmbbp_search_input" name="searchFilter.searchFilters[5].stringValue" placeholder="内置数据">
									<option value="admin" selected="selected">全部</option>
									<option value="true">是</option>
									<option value="false">否</option>
								</select>
						...
						<div class="form-group col-sm-6 gmbbp_search_formgroup">
							...
							<div class="col-sm-8">
								<input type="hidden" name="searchFilter.searchFilters[6].columnName" value="gmkeycode" />
							    ...
							    <input type="text" class="form-control gmp_input" name="searchFilter.searchFilters[6].stringValue"
									value="${gmbbasedatadic.gmkeycode}" placeholder="关键字" />
							</div>
						</div>
						<div class="form-group col-sm-6 gmbbp_search_formgroup">
							<label  class="col-sm-4 control-label gmbbp_inputtext">排序号：</label>
							<div class="col-sm-8">
								<input type="hidden" name="searchFilter.searchFilters[7].columnName" value="gmorder" />
							    ...
							    <input type="text" class="form-control gmp_input" name="searchFilter.searchFilters[7].stringValue"
									value="${gmbbasedatadic.gmorder}" placeholder="排序号" />
							</div>
						</div>
					</div>
					<!-- 高级查询表单结束 -->
	...
	<div tabindex="-1" class="modal fade" id="batchExport" role="dialog" aria-hidden="true" aria-labelledby="myModalLabel">
		<div class="modal-dialog">
			<div class="modal-content gmbbp_search_box">
						...
						<table class="table">
							<tbody>
								<tr>
									...
									<tr>
										<td><input type="checkbox" name="gmbbp_modal_ids" value="code" class="gmbbp_modal_ids"></td>
										<td>代码</td>
									</tr>
									<tr>
									...
									<tr>
										<td><input type="checkbox" name="gmbbp_modal_ids" value="description" class="gmbbp_modal_ids"></td>
										<td>描述</td>
									</tr>
									<tr>
										<td><input type="checkbox" name="gmbbp_modal_ids" value="isInternal" class="gmbbp_modal_ids"></td>
										<td>内置数据</td>
									</tr>
									<tr>
										<td><input type="checkbox" name="gmbbp_modal_ids" value="gmkeycode" class="gmbbp_modal_ids"></td>
										<td>关键字</td>
									</tr>
									<tr>
										<td><input type="checkbox" name="gmbbp_modal_ids" value="gmorder" class="gmbbp_modal_ids"></td>
										<td>排序号</td>
									</tr>
							</tbody>
						</table>
				...
				<div class="modal-footer gmbbp_search_foot">
					<a class="gmbbp_list_displaynone" href="Gmbbasedatadic!gmbList.action?handle=forwardAjaxList&exportState=true&fields=" style="display:none;"></a>
