			...
			<div class="col-md-12 gmbbp_remove_style gmbbp_int_formcreat gmb_pageinfo gmb_Validator">
				<div class="gmbbp_int_formlisttitle">
					<ul class="nav nav-tabs gmbbp_tab_panel column ui-sortable" role="tablist">
						<li role="presentation" class=" lyrow ui-draggable showAttr active" data-setting = "1"><a href="#tabgmcreditcard" aria-controls="home" role="tab" data-toggle="tab">信用卡基本信息</a></li>
					</ul>
				</div>
				<div class="tab-content gmbbp_formlistcon gmbbp_modal_infoallcheck">
					<div role="tabpanel" class="tab-pane active" id="tabgmcreditcard">
							...
							<div class="lyrow ui-draggable">
								<div class="col-md-12 column ui-sortable gmbbp_batchinputform_formgroup gmbbp_cont_treeborderNo gmdemolist">
									...
									<div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 lyrow ui-draggable" data-setting = "1">
										...
										<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
											<label class="gmbbp_infoform_label">
													<fmt:formatDate value="${gmcreditcard.validitydate}" pattern="yyyy-MM-dd HH:mm:ss"/>
											</label>
										</div>
									</div>
										<div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 lyrow ui-draggable" data-setting = "1">
									...
									<div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 lyrow ui-draggable" data-setting = "1">
										...
										<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
											<label class="gmbbp_infoform_label">
													<fmt:formatDate value="${gmcreditcard.accountday}" pattern="yyyy-MM-dd HH:mm:ss"/>
											</label>
										</div>
									</div>
									<div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 lyrow ui-draggable" data-setting = "1">
										...
										<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
											<label class="gmbbp_infoform_label">
													<fmt:formatDate value="${gmcreditcard.repaymentday}" pattern="yyyy-MM-dd HH:mm:ss"/>
											</label>
										</div>
									</div>
										<div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 lyrow ui-draggable" data-setting = "1">
									...
									<div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 lyrow ui-draggable" data-setting = "1">
										...
										<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
											<label class="gmbbp_infoform_label">
													<fmt:formatDate value="${gmcreditcard.creattime}" pattern="yyyy-MM-dd HH:mm:ss"/>
											</label>
										</div>
									</div>
									<div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 lyrow ui-draggable" data-setting = "1">
										...
										<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
											<label class="gmbbp_infoform_label">
													<fmt:formatDate value="${gmcreditcard.updatetime}" pattern="yyyy-MM-dd HH:mm:ss"/>
											</label>
										</div>
									</div>
									<div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 lyrow ui-draggable" data-setting = "1">
