...
<div class="container-fluid gmp GMAdmin">
	...
	<form style="width:100%;height:100%;display:inline-block;" id="listForm" method="post" class="form-horizontal column ui-sortable gmbbp_cont_treeborderNo" action="Gmbbasedatadic!${isAddAction?'gmbAdd':'gmbUpdate'}.action" role="form">
							...
							<div class="col-md-12">
								...
								<div class="gmbbp_cont_treecon" style="padding-left:20px;display:none;">
									...
									<div class="zTreeDemoBackground left bg-ztree">
										<ul id="treegmbbasedatadic_input" class="ztree GMZtree" gmOnClick="zTreeOnClick" gmTreeIsEnable="false" gmTreeShowName="name" gmTreeUrl="<%=gmBase%>/finance/Gmbbasedatadic!gmbList.action?handle=forwardListParentTree"></ul>
									</div>
								</div>
							</div>						
						</div>
			...
			<div class="col-md-10 gmbbp_contentbox gmbbp_height gmbbp_size_right">
				<div class="col-md-12 gmbbp_content_right">
					<div class="col-md-12 gmbbp_con_righttitle">
						<!--内容右侧title部分开始-->
						<div class="gmbbp_conright_logo">&nbsp;&nbsp;${isAddAction?'创建':'编辑'}数据字典</div>
					</div>
					<!--右侧编辑部分-->
					<div class="col-md-12 gmbbp_int_formcreat gmb_pageinfo">
						<div class="col-md-12 gmbbp_int_formlisttitle">
							<ul class="nav nav-tabs gmbbp_tab_panel column ui-sortable" role="tablist">
								<li role="presentation" class="lyrow ui-draggable active" data-setting = "1"><a href="#tabgmbbasedatadic" aria-controls="home" role="tab" data-toggle="tab">数据字典基本信息</a></li>
							</ul>
						</div>
								...
								<div class="col-md-12 column ui-sortable gmbbp_cont_treeborderNo">
											...
											<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
												<input type="text" class="form-control gmbbp_input  gmb_required" maxlength="45"
													name="gmbbasedatadic.name" value="${gmbbasedatadic.name}"
										...
										<div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12 lyrow ui-draggable" data-setting = "1">
											...
											<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
												<input type="text" class="form-control gmbbp_input  gmb_required" maxlength="45"
													name="gmbbasedatadic.code" value="${gmbbasedatadic.code}"
									...
									<div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12 lyrow ui-draggable" data-setting = "1">
										...
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
											<div class="input-group from-tree" gmZtreeTid="nameparentNode" title="点击选择目录" gmKeyName="name"
												...
												<input type="hidden" name="gmbbasedatadic.parentid" value="${isAddAction ? addGmbbasedatadic.id==null?"0":addGmbbasedatadic.id : gmbbasedatadic.parentid }" readonly/>
									...
									<div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12 lyrow ui-draggable " data-setting = "1">
										...
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
											<select class="form-control gmbbp_input " name="gmbbasedatadic.isParent" placeholder="是否是父节点">
												<option value="">请选择</option>
												<option value="true" ${(gmbbasedatadic.isParent||isAddAction)?'selected="selected"':''}>是</option>
												<option value="false" ${(!gmbbasedatadic.isParent&&!isAddAction||(!isCatalog&&isAddAction))?'selected="selected"':''}>否</option>
											</select>
										</div>
									</div>
										<div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12 lyrow ui-draggable" data-setting = "1">
											...
											<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
												<input type="text" class="form-control gmbbp_input " maxlength="45"
													name="gmbbasedatadic.description" value="${gmbbasedatadic.description}"
													placeholder="描述"/>
											</div>
										</div>
									<div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12 lyrow ui-draggable " data-setting = "1">
										...
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
											<select class="form-control gmbbp_input " name="gmbbasedatadic.isInternal" placeholder="内置数据">
												<option value="">请选择</option>
												<option value="true" ${(gmbbasedatadic.isInternal||isAddAction)?'selected="selected"':''}>是</option>
												<option value="false" ${(!gmbbasedatadic.isInternal&&!isAddAction)?'selected="selected"':''}>否</option>
											</select>
										</div>
									</div>
										<%-- <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12 lyrow ui-draggable" data-setting = "1">
											...
											<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
												<input type="text" class="form-control gmbbp_input " maxlength="320"
													name="gmbbasedatadic.gmkeycode" value="${gmbbasedatadic.gmkeycode}"
													placeholder="关键字"/>
											</div>
										</div> --%>
										<div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12 lyrow ui-draggable" data-setting = "1">
											...
											<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
												<input type="text" class="form-control gmbbp_input " maxlength="10"
													name="gmbbasedatadic.gmorder" value="${gmbbasedatadic.gmorder}"
													placeholder="排序号"/>
											</div>
										</div>
								</div>
